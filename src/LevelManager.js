    ...
    addEnemyToGameLayer: function (enemyType) {
        ...
        switch (addEnemy.moveType) {
            ...
            case MW.ENEMY_MOVE_TYPE.OVERLAP:
                //Add code here
                var disY = winSize.height * 0.3;
                var disX = winSize.width * 0.5;
                var newX = (addEnemy.x <= winSize.width / 2) ? disX : -disX;
                a0 = cc.moveBy(4, cc.p(newX, -disY));
                a1 = cc.moveBy(4, cc.p(-newX, -disY));
